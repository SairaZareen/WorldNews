...
import com.skz.mynews.databinding.FragmentSavedBinding
...
class SavedFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        ItemTouchHelper(itemTouchHelperCallback).apply {
            attachToRecyclerView(fragmentSavedBinding.recyclerSavedNews)
        }
    }


    private fun initRecyclerView(){
        fragmentSavedBinding.recyclerSavedNews.apply {
            adapter = newsAdapter
