...
import com.skz.mynews.databinding.FragmentNewsBinding
...
class NewsFragment : Fragment() {
   ...
   // newsAdapter = NewsAdapter()
    ...
    private fun setSearchView(){
        fragmentNewsBinding.seachViewNews.setOnQueryTextListener(
        ...
        fragmentNewsBinding.seachViewNews.setOnCloseListener(
